namespace Cars.Tests.JustMock
{
    ...
    public class CarsControllerTests
    {
        ...
        public void Details_ShouldAccessICarsRepositoryGetById()
        {
            ...
            var fakeCarRepo = new Mock<ICarsRepository>();
            fakeCarRepo.Setup(z => z.GetById(It.IsAny<int>())).Returns(fakeCar.Object);
            ...
            // Assert
            fakeCarRepo.Verify(z => z.GetById(It.IsAny<int>()), Times.Exactly(1));
        }
        ...
        public void Details_CarReturnedByGetByIdIsNull_ShouldThrowTheCorrectMessage()
        {
            ...
            {
                actual = ex.Message.Contains("Car not found");
            }
        ...
        public void Search_ShouldAccessICarsRepositorySearch()
        {
            ...
            var fakeCarRepo = new Mock<ICarsRepository>();
            fakeCarRepo.Setup(z => z.Search(It.IsAny<string>())).Returns(new List<Car>() { fakeCar.Object });
            ...
            // Assert
            fakeCarRepo.Verify(z => z.Search(It.IsAny<string>()), Times.Exactly(1));
        }
        ...
        public void Sort_ParameterIsNotRecognized_ShouldThrowTheCorrectExceptionMessage()
        {
            ...
            {
                actual = ex.Message.Contains("Invalid sorting");
            }
        ...
        public void Sort_ParameterMakeShouldCallTheCorrectSortingMethod()
        {
            ...
            var fakeCarRepo = new Mock<ICarsRepository>();
            fakeCarRepo.Setup(z => z.SortedByMake()).Returns(new List<Car>() { new Car() });
            ...
            // Assert
            fakeCarRepo.Verify(z => z.SortedByMake(), Times.Exactly(1));
        }
        ...
        public void Sort_ParameterYearShouldCallTheCorrectSortingMethod()
        {
            ...
            var fakeCarRepo = new Mock<ICarsRepository>();
            fakeCarRepo.Setup(z => z.SortedByYear()).Returns(new List<Car>() { new Car() });
            ...
            // Assert
            fakeCarRepo.Verify(z => z.SortedByYear(), Times.Exactly(1));
        }
